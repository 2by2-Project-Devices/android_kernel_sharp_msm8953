...
#ifdef CONFIG_BATTERY_SHARP
static int smb5_shdiag_mode_initialize(const char *val,
...
static int battery_charging_enabled_set(const char *val,
		const struct kernel_param *kp)
{
    int ret,value;
    struct smb_charger *chg = &the_chip->chg;
...
static int battery_charging_enabled_get(char *buf,
		const struct kernel_param *kp)
{
    int ret, value;
    struct smb_charger *chg = &the_chip->chg;
...
static int input_current_max_set(const char *val,
		const struct kernel_param *kp)
{
    int ret,value;
    struct smb_charger *chg = &the_chip->chg;
...
static int input_current_max_get(char *buf,
		const struct kernel_param *kp)
{
    int ret, value;
    struct smb_charger *chg = &the_chip->chg;
...
static int smb5_lcd_on_get(char *buf, const struct kernel_param *kp)
{
   int ret, level=0;
...
static int smb5_boot_completed_get(char *buf,
		const struct kernel_param *kp)
{
    int ret, usb_therm;
    struct smb_charger *chg = &the_chip->chg;
...
static int offcharge_mode_set(const char *val,
		const struct kernel_param *kp)
{
	int ret,value;
	struct smb_charger *chg = &the_chip->chg;
